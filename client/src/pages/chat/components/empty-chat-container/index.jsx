...
const EmptyChatContainer = () => {
  ...
  return (
    ...
    <div className="fixed  top-0 h-[100vh] w-[100vw] bg-white flex flex-col md:static md:flex-1 ">
      ...
      <div className="px-5 text-opacity-80 text-black flex flex-col gap-5 items-center lg:text-4xl md:text-3xl text-xl transition-all duration-300 text-center">
